...
export const DOCUMENTS: Document[] = [
  // Hướng dẫn thử áp
  {
    ...
    url: '/api/admin/documents/file/testing/test-hdpe.pdf',
    size: '1.2 MB',
  ...
  },
  {
    ...
    url: '/api/admin/documents/file/testing/test-ppr.pdf',
    size: '0.8 MB',
    updatedAt: '2024-03-21',
  },
  {
    ...
    url: '/api/admin/documents/file/testing/test-pvcu.pdf',
    size: '1.0 MB',
    updatedAt: '2024-03-21',
  },
  {
    ...
    url: '/api/admin/documents/file/testing/test-corrugated.pdf',
    size: '1.5 MB',
    updatedAt: '2024-03-21',
  },
  ...
  // Hướng dẫn lắp đặt
  {
    ...
    url: '/api/admin/documents/file/install/install-hdpe.pdf',
    size: '2.4 MB',
    updatedAt: '2024-03-21',
  },
  {
    ...
    url: '/api/admin/documents/file/install/install-ppr-tech.pdf',
    size: '1.8 MB',
    updatedAt: '2024-03-21',
  },
  {
    ...
    url: '/api/admin/documents/file/install/install-pvcu.pdf',
    size: '1.6 MB',
    updatedAt: '2024-03-21',
  },
  {
    ...
    url: '/api/admin/documents/file/install/install-corrugated.pdf',
    size: '2.1 MB',
    updatedAt: '2024-03-21',
  },
];
