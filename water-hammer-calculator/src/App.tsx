        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
          ...
          <main className="lg:col-span-8 space-y-8">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              <ResultCard title="Vận tốc dòng chảy" value={results.velocity} unit="m/s" subtitle="Dòng ổn định" />
               ...
               <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                 <div className="space-y-4">
                   <div className="flex gap-3">
                     <div className="p-2 bg-blue-100 rounded-lg text-blue-600 h-fit"><CheckCircle2 className="w-4 h-4" /></div>
                     <div>
                       <p className="text-xs font-bold uppercase tracking-tight">Kỹ thuật DN: {inputs.dn}</p>
                       <p className="text-sm text-slate-600 mt-1">Vận tốc dòng <strong>{results.velocity} m/s</strong>. 
                        {parseFloat(results.velocity) > 2.0 ? " Áp suất búa nước sẽ cao do vận tốc lớn. Cân nhắc tăng DN." : " Vận tốc trong ngưỡng an toàn cao."}
                       </p>
                     </div>
                   </div>
                    ...
                    <div className="px-8 pb-8 space-y-8 text-sm text-slate-600 leading-relaxed border-t border-slate-100 mt-0 pt-6">
                      ...
                      <section className="space-y-3">
                        ...
                        <p className="text-xs">
                          ...
                          Vận tốc lý tưởng khuyến cáo: <b>1.5 - 2.5 m/s</b>.
                        </p>
                      </section>
